        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                    ...
                    <!--<h1 class="text-primary m-2"><i class="fa fa-utensils me-3"></i>Restoran</h1>-->
                     <img style="width:200px; height:100px" src="img/logo.png" alt="Logo"> 
                </a>
            ...
            <div class="container-xxl py-5 bg-dark hero-header">
                <div class="container my-2 py-5">
                    <div class="row align-items-center g-5">
                        ...
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Welcome to House of Food</h5>
                        ...
                        <form action="register.php" method="post">
                            <div class="row g-3">
                               <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" id="password" placeholder="Your Password" name="pass1">
                                        <label for="password">Your Password</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" id="password" placeholder="Confirm Your Password" name="pass2">
                        ...
                        <br><p class="text-white animated slideInLeft mb-4 pb-2"> Already have an account? <a href="index.php" >Sign In</a></p>
                    </div>
