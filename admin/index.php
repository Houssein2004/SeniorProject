        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                   ...
                   <!--  <h1 class="text-primary m-2"><i class="fa fa-utensils me-3"></i>Restoran</h1>-->
                    <img style="width:240px; height:130px" src="../img/logo.png" alt="Logo"> 
                </a>
            ...
            <div class="container-xxl py-5 bg-dark hero-header">
                <div class="container my-2 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start"><br><br>
                        <a href="../index.php" class="btn btn-primary py-2 px-4">back</a><br><br>
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Welcome to House of Food - Admin Area</h5>
